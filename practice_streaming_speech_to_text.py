import sys
sys.path.append("c:/users/liang/appdata/local/programs/python/python38/lib/site-packages")
import os
...
os.environ['GOOGLE_APPLICATION_CREDENTIALS'] = 'pure-ace-306204-58b84a40b3b3.json'
